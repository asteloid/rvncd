...
get_prebuilts() {
	...
	RV_CLI_URL=$(gh_req https://api.github.com/repos/inotia00/revanced-cli/releases/latest - | json_get 'browser_download_url')
	...
	RV_PATCHES_CHANGELOG=$(echo "$RV_PATCHES" | json_get 'tag_name')
	...
	log "\n[${RV_PATCHES_CHANGELOG##*/}](https://github.com/inotia00/revanced-patches/releases/latest)\n"
...
build_rv() {
	...
	for build_mode in "${build_mode_arr[@]}"; do
		...
		local module_output="${app_name_l}-v${version}-${arch}.zip"
